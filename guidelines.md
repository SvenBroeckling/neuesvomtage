...
These are the coding guidelines for the neuesvomtage project.

## Project Defaults

- Use bootstrap5 and django_bootstrap5 in HTML templates, avoid writing custom css
- Use django_bootstrap5 {% form %} and {% field %} tags, don't create custom forms using html markup
...
- Use django_bootstrap5 forms for better form rendering
